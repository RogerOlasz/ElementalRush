...
{    
    ...
    public float progress_duration = 1f;
    ...
    //IEnumerator AddingCraftingMaterial()
    //{
    ...
    void Update()
    {
        if(slot_1 != PlayerItemManager.Items.None && slot_2 != PlayerItemManager.Items.None)
        {
